...
export default function UserQuizFillForm() {
    ...
    const [userQuestion, setUserQuestion] = useState<UserQuestion>(
        new UserQuestion()
    )
    ...
    async function onSubmit() {
        const answers = [selectedAnswer, ...[...selectedAnswers]]
        try {
    ...
    return isLoading ? (
        ...
        <div className="user-quiz-fill-form-container">
            ...
            <Stepper active={active} mt="lg">
                <Stepper.Step
                    label="Ver Video"
                    description="Ve el video completo antes de responder la encuesta"
                ></Stepper.Step>
                ...
                <Stepper.Step label="Fin" description="Completado">
                    <UserQuizForm
                        ...
                        selectMultiAnswer={selectMultiAnswer}
