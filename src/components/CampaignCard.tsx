...
export default function CampaignCard({ c }: Params) {
    return (
        ...
        >
            <Card.Section>
                <Image alt="logo" height={200} src={c.image_url} />
            </Card.Section>
            <Flex gap="sm" mt="sm">
                <Map />
                <Text fw={700}>
                    {c.name && trimAndCapitalize(c.name, maxHeadingLength)}
                </Text>
            </Flex>
            <Text
                size="sm"
            ...
            <Group justify="space-between" mt="md">
                <Flex gap="5px" align="center">
                    ...
                    <Text size="lg" pt="3px">
                        {c.user.name && capitalizeAllWords(c.user.name)}
                    </Text>
                </Flex>
