        ...
        <div className="quiz-unregister-form">
            <div className="form-description">
                <h1 className="heading">
                    Antes de responder la encuesta, es necesario que te
                    registres!
                </h1>
                <div>
                    Haz click en CONTINUAR para acceder a tu registro. Te tomara
                    5 minutos el proceso.
                </div>
                <div></div>
                <Button
                    variant="outline"
        ...
        <div className="quiz-unregister-form">
            <div className="form-description">
                ...
                <div className="description">
                    ...
                    <div>
                        ¡Ya casi estás ahí. Haga clic en el botón de abajo para
                        finalizar INICIAR SESIÓN
                    </div>
                </div>
            </div>
        </div>
